...
test("Team Map pages use independent column flow",()=>{const html=fs.readFileSync("admin/index.html","utf8");assert(html.includes("--team-map-name-size:15px")&&html.includes("mode, false")&&html.includes("mode, true")&&html.includes("firstColumnCapacity"),"independent page flow missing");});
