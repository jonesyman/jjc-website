...
test("Team Map names use measured capacity and clipping protection",()=>{const html=fs.readFileSync("admin/index.html","utf8");assert(html.includes("--team-map-name-size:13px")&&html.includes("--team-map-name-size:9.5px")&&html.includes("font-weight:600")&&html.includes("firstColumnCapacity")&&html.includes("name.scrollWidth>name.clientWidth+1")&&html.includes("anyListOverflows()||anyNameClipsRight()")&&html.includes("requestAnimationFrame(fitTeamMapNames)"),"measured name fitting missing");});
