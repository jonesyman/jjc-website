...
- Workshops and saved groups provide copy-ready facilitator slide notes with at most one strongest color-coded highlight per Working Genius type. Aggregate recommendations highlight only the single most dominant overrepresented stage, and call out Responsive/Disruptive only when a concentration is unusually strong. Detailed W/I/D/G/E/T prompts include the distribution percentages.
