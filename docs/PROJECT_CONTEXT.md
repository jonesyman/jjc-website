...
- Workshops and saved groups provide copy-ready facilitator slide notes with at most one strongest color-coded highlight per Working Genius type, stage of work, and Responsive/Disruptive side. Detailed W/I/D/G/E/T prompts include the distribution percentages.
